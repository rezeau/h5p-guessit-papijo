...
H5P GuessIt 1.9.1 requires H5P Core API 1.28. It has been tested successfully on
...
`H5P.GuessIt-1.9.1.h5p` through the platform's H5P library administration
